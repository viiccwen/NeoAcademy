...
export function getQuizById(user: User, quizId: string): Quiz | UnansweredQuiz | undefined {
...
export async function deleteQuizById(user: User, quizId: string): Promise<void> {
    await users.updateOne(
        { _id: user._id },
